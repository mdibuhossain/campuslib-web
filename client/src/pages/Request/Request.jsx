...
const Request = () => {
  ...
  const [postContentBook, { data: data1, loading: postBookLoading }] =
    useMutation(POST_BOOK, {
  ...
  const [postContentQuestion, { data: data2, loading: postQuestionLoading }] =
  ...
  const [postContentSyllabus, { data: data3, loading: postSyllabusLoading }] =
    useMutation(POST_SYLLABUS, {
  ...
  return (
    <>
      <Helmet>
        <title>Upload Content | Campus Library</title>
        <meta
          name="description"
            ...
            <Grid item md={6}>
              <Box sx={{ display: { md: "block", xs: "none" } }}>
                <img
                  ...
                  src="assets/images/request.webp"
                  alt="request banner"
                />
              </Box>
            </Grid>
            <Grid item md={6} sx={{ m: "auto" }}>
              <Box sx={{ fontWeight: 600, textAlign: "center", mb: 4 }}>
                ...
                {!user?.email && (
                  <NavLink
                    to="/login"
                    style={{
                      color: blink ? "powderblue" : "limegreen",
              ...
              <Box
                sx={{
                  ...
                  bgcolor: "white",
                  borderRadius: 2,
                  boxShadow: "0.65px 1.75px 10px rgb(0, 0, 0, 0.3)",
                }}
              >
                <form onSubmit={handlePost}>
                  ...
                  <FormControl fullWidth sx={{ mb: 2 }}>
                    <InputLabel id="department-selection">
                      Department
                    </InputLabel>
                    <Select
                  ...
                  {dataStruct?.sub_categories === "book" && (
                    <Tooltip
                      title="only select if applicable"
                      placement="top-end"
                      arrow
                    >
                      <FormControl fullWidth sx={{ mb: 2 }}>
                        <InputLabel htmlFor="semester-select">
                          Semester
                        </InputLabel>
                        <Select
                          value={semester ?? []}
                        ...
                        >
                          {semesterList.map((sem) => {
                            ...
                            return (
                              <MenuItem key={sem} value={sem} sx={{ ml: 1 }}>
                                {sem}
                              </MenuItem>
                            );
                          })}
                  ...
                  postBookLoading ? (
                    ...
                    <Button
                      ...
                      disabled={
                        !(
                          dataStruct.sub_categories &&
                          dataStruct.book_name &&
                          dataStruct.categories &&
                          dataStruct.download_link
                        )
                      }
                    >
                      UPLOAD
