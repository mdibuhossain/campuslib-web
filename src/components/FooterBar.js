        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800 sticky top-[100vh]">
            ...
            <div className="sm:flex sm:items-center text-center sm:justify-between">
                ...
                <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
                    <a href="https://www.facebook.com/mdibuhossain" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer" target="_blank">
                    ...
                    <a href="https://instagram.com/mdibuhossain" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer" target="_blank">
                    ...
                    <a href="https://github.com/mdibuhossain" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer" target="_blank">
                    ...
                    <a href="https://youtube.com/expertinall" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer" target="_blank">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" clip-rule="evenodd"></path></svg>
                    </a>
                </div>
            </div>
        </footer>
