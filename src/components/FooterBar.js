...
const FooterBar = () => {
    return (
        <footer className="p-4 bg-white sm:p-6 bg-gray-900 sticky top-[100vh]">
            ...
            <div className="sm:flex sm:items-center text-center sm:justify-between">
                ...
                <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
                    ...
                    <a href="https://instagram.com/mdibuhossain" className="text-gray-500 hover:text-gray-300 dark:hover:text-white" rel="noreferrer" target="_blank">
                    ...
                    <a href="https://github.com/mdibuhossain" className="text-gray-500 hover:text-gray-300 dark:hover:text-white" rel="noreferrer" target="_blank">
                    ...
                    <a href="https://youtube.com/expertinall" className="text-gray-500 hover:text-gray-300 dark:hover:text-white" rel="noreferrer" target="_blank">
